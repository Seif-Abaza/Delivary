...
<html lang="en">
    <head>
        ...
        <meta name="description" content="<?php echo SystemVariable(FILED_SYSTEM_APPLICATION_NAME); ?>">
        <meta name="author" content="<?php echo SystemVariable(FILED_SYSTEM_POWER_BY); ?>">
    ...
    <body>
        ...
        <section id="container" class="">
            ...
            <header class="header dark-bg">
                ...
                <!--logo start-->
                <a href="index.php" class="logo"><?php echo SystemVariable(FILED_SYSTEM_APPLICATION_NAME); ?></span></a>
                <!--logo end-->
